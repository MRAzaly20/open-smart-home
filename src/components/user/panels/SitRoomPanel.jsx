...
const SitRoomPanel = () => {
    ...
    return (
        <div>
            <div
                className='w-full h-auto md:px-2 md:w-[65.7rem] grid grid-cols-2
                md:grid-cols-4 gap-4 md:gap-4'
            >
                <CardPanel
                    room_name={"Lamp Control"}
                    path={"/user/room/sitroom/LampControl"}
                />
                <CardPanel
                    room_name={"AC Control"}
                    path={"/user/room/sitroom/AirControl"}
                    onState={() => setIsToggled(!isToggled)}
                />
                <CardPanel
                    room_name={"Aquarium  Control"}
                    onState={() => setIsToggled(!isToggled)}
                />
                <CardPanel
